    ...
    public function run(): void
    {
        foreach ([
            [
                'number' => 1,
                'title' => 'Review',
                'summary' => 'A 13-step audit of media, ad tech, creative, and business priorities before we touch a single dollar.',
            ...
            [
                'number' => 2,
                'title' => 'Operate',
                'summary' => 'Active ads management — ad units, audiences, copy, visuals, and budgets adjusted daily, not monthly.',
            ...
            [
                'number' => 3,
                'title' => 'Improve',
                'summary' => 'Kaizen. Constant measurement, creative testing, attribution, and planning feed back into Review.',
